...
func (e *etcdLeader) Elect(ctx context.Context, id string, opts ...leader.ElectOption) (leader.Elected, error) {
	...
	// make path
	pathstr := path.Join(e.path, strings.Replace(id, "/", "-", -1))
